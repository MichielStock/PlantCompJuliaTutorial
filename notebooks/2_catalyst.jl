...
# ╔═╡ 66629222-81bc-4711-b094-1692c95a3c7b
...
# ╔═╡ d0b85269-7ee0-49be-ab70-ba14ad3af158
PlutoUI.LocalResource("images/photosynthesis.png")
...
# ╔═╡ cfee3d35-a01e-4bd2-a99c-40b056ce2ea4
PlutoUI.LocalResource("images/photorespiration.png")
...
md"""
When too much oxygen is present, the Calvin cycle is inhibited, leading to the loss of fixed carbon dioxide and a decreased carbohydrate synthesis. This process is called *photorespiration*. 
"""
...
In C4 plants, the first stable product of photosynthesis is a compound with four carbon atoms called malate.
...
# ╔═╡ 0aa49094-5f3f-4d98-9dba-ff0b1e36a08e
PlutoUI.LocalResource("images/c3_and_c4_models.png")
...
# ╔═╡ f53a82fe-0f8d-4878-a00f-bb383c9365cf
md"""
## Exercise

> **Exercise** Implement the following reactions as a reaction system
> ```
> (k1, k2 / 2), E + S <--> E + P
> k2, S + P --> 2A
> k3, A --> 0
> ```
> Start with an initial concentration for `S` of 10.0, `E` as 0.2 and 0 for `P` and `A`, take `k1 = 1.2`, `k2 = 0.2`, `k3 = 0.3`. Simulate and plot the systen.
"""

# ╔═╡ 9c77f8ef-7f0a-42df-b57a-ad8d7af4b274


# ╔═╡ b86ca4a1-0cc7-4f00-b960-a5ea0b5665df


# ╔═╡ 57294b23-45ad-4114-87e7-0224a837adf6


# ╔═╡ 9f790f98-80f6-4e53-b2bc-d8ad481dbc4d
md"Show solution: $(@bind showsol CheckBox())"

# ╔═╡ ac21e2c0-af13-46ba-b36e-6b030899280e
if showsol
md"""
```julia
...
```julia
oprob2 = ODEProblem(rn2, [:S=>100.0, :E=>0.2, :P=>0.0, :A=>0.0], (0.0, 10.0), [:k1=>01.2, :k2=>0.2, :k3=>0.3])
```
